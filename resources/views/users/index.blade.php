                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-md" id="tooltip-container">
                            <a href="{{ route('user.edit',$user->id) }}" class="btn btn-primary"  data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('dash.edit')">
                            ...
                            <form action="{{ route('user.destroy',$user->id) }}" method="post" id="ss" class="">
                                ...
                                <button onclick="return confirm('Are you sure delete user?')" type="submit" data-id="#ss" data-name="#" class="btn btn-dark del"  data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('dash.delete')">
